...
//addedd on 27/11/2022
  final my_leave_report = 'http://localhost:8089/applyforleave'; //testing
  final my_leave_approve_request =
      '/bbhrm_app/api/Leave/GetRemainingLeave/15857';
  final my_leave_details = '/bbhrm_app/api/Leave/GetLeavedetails';
  final my_leave_search = '/bbhrm_app/api/Leave/GetLeavesearch';
  ...
  //Added on 28/11/2022
  final my_leave_getdivision = '/bbhrm_app/api/BasicData/DivisionList';
  final my_leave_getdistrict_bydivision =
      '/bbhrm_app/api/BasicData/DistrictList'; //currently returning only district it should be by division
  final my_leave_getthanaby_district =
      '/bbhrm_app/api/BasicData/ThanaList'; //Return Thana list by district
  // Forgot Password
