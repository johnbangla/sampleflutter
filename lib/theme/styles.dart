...
class Styles {
  ...
  static var drawerItemStyle = GoogleFonts.roboto(
      fontWeight: FontWeight.w400,
      fontSize: 14,
      color: ColorResources.GREY_DARK);

  static var menuListItemStyle = GoogleFonts.inter(
      fontWeight: FontWeight.w700,
      fontSize: 14,
      color: ColorResources.GREY_NINETY);

  static var listButtonTextStyle = GoogleFonts.poppins(
      fontWeight: FontWeight.w600,
      fontSize: 12,
      color: ColorResources.GREY_NINETY);

  static var cancelButtonTextStyle = GoogleFonts.poppins(
      fontWeight: FontWeight.w600,
      fontSize: 12,
      color: ColorResources.CANCEL_BUTTON_TEXT_COLOR);

  static var listDescTextStyle = GoogleFonts.inter(
      fontWeight: FontWeight.w400,
      fontSize: 12,
      color: ColorResources.GREY_DARK_SIXTY);

  static var listDescHeadingTextStyle = GoogleFonts.inter(
      fontWeight: FontWeight.w600,
      fontSize: 12,
      color: ColorResources.GREY_DARK);
  static var listDescWithHeadTextStyle = GoogleFonts.inter(
      fontWeight: FontWeight.w400,
      fontSize: 12,
      color: ColorResources.GREY_DARK);

  static var editBillButtonTextStyle = GoogleFonts.poppins(
      fontWeight: FontWeight.w600,
      fontSize: 12,
      color: ColorResources.GREY_NINETY);

  static var downBillButtonTextStyle = GoogleFonts.poppins(
      fontWeight: FontWeight.w600,
      fontSize: 12,
      color: ColorResources.LIGHT_YELLOW);

  static var nextPrevTextStyle = GoogleFonts.poppins(
      fontWeight: FontWeight.w600,
      fontSize: 14,
      color: ColorResources.GREY_NINETY);

  static var approveListHeaderTextStyle = GoogleFonts.inter(
      fontWeight: FontWeight.w700,
      fontSize: 14,
      color: ColorResources.GREY_NINETY);
  static var approveListTextStyle = GoogleFonts.inter(
      fontWeight: FontWeight.w500,
      fontSize: 12,
      color: ColorResources.GREY_NINETY);

  static var acceptButtonTextStyle = GoogleFonts.poppins(
      fontWeight: FontWeight.w600,
      fontSize: 12,
      color: ColorResources.ACCEPT_ICON_COLOR);

  static var rejectButtonTextStyle = GoogleFonts.poppins(
      fontWeight: FontWeight.w600,
      fontSize: 12,
      color: ColorResources.CANCEL_BUTTON_TEXT_COLOR);
  ...
  static var inactiveTextColor = GoogleFonts.dmSans(
      ...
      fontWeight: FontWeight.w700,
      fontStyle: FontStyle.normal,
      color: ColorResources.GREY_EIGHTY);
}
