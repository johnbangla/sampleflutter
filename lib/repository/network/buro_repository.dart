...
//   }
 Future<dynamic> getDivisionList() async {
  ...
  // Future<String> getDivisionListBycountry(var country) async {
  //   return await _provider.getDivisionListBycountry(country);
  // }
 Future<dynamic> getDistricttListByDivision(var div) async {
    return await _provider.getDistricttListByDivision(div);
  }
